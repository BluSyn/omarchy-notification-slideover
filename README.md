...
- **Barely transparent.** The sheet uses the theme background, shifted toward black or white for contrast, at ~98% opacity so it still reads as glass without letting busy windows through.
